...
const BlogIntro = () => {
  return (
    <section className="w-full mt-32 flex flex-col-reverse lg:flex-row items-center mb-12">
      <div className="w-full lg:w-[55%]">
        <h1 className="w-full mt-5 lg:mt-0 lg:w-[85%] text-4xl md:text-5xl font-semibold text-primary">
          Your Trusted Guide to Health: Stay Informed with Our Blog
        </h1>
        <p className="w-full lg:w-[85%] text-stone-500 text-[17px] mt-3 mb-7 lg:mt-5">
      ...
      <img
        ...
        className="lg:flex-1 w-full lg:w-[40%] h-fit object-contain object-center rounded-3xl"
      />
