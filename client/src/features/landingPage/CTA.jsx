...
const CTA = () => {
  return (
    ...
    >
      <div className="w-full h-full bg-black/50 flex flex-col items-center justify-center px-4">
        <h1 className="text-secondary text-center text-3xl sm:text-4xl md:text-5xl font-semibold">
          Your Journey to Wellness Starts Here!
        </h1>
        <p className="md:w-[70%] text-center text-white mt-4">
